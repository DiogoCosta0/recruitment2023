...
mlp_optimizer_m1 = torch.optim.SGD(model1.parameters(), lr=MLP_LEARNING_RATE, momentum=MLP_MOMENTUM)
...
#utils.train_model(model1, MLP_EPOCHS, mlp_optimizer_m1, mlp_loss_fn, mlp_training_loader, mlp_validation_loader, LOGGING_INTERVAL)
